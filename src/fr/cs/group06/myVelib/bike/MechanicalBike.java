/**
 * The MechanicalBike class represents a mechanical bike in the MyVelib system.
 */
 ...
 * The MechanicalBike class represents a mechanical bike in the MyVelib system.
 */
public class MechanicalBike implements Bike {
    ...
    /**
     * Constructs a new MechanicalBike object with the specified parameters.
     *
     * @param id                the ID of the bike
     * @param location          the location of the bike
     * @param dockingStation    the docking station where the bike is located
     */
    public MechanicalBike(int id, Location location, DockingStation dockingStation) {
        this.BikeId = id;
    ...
    /**
     * Allows a user to rent the mechanical bike.
     *
    ...
    public void rent(User user) {
        if (user.hasRentedBike()) {
            ...
            double updatedElectricalBikes = totalElectricalBikes;
    ...
    /**
     * Allows a user to return the mechanical bike.
     *
     ...
     *
     * @return the bike type as a string ("Mechanical")
     */
    @Override
    ...
    /**
     * Displays information about the mechanical bike.
     */
    @Override
    public void showBike() {
        System.out.println("Mechanical Bike of Id = "+this.getId());
    }

    /**
     * Gets the ID of the mechanical bike.
     *
     * @return the bike ID
     */
    @Override
    ...
    /**
     * Sets the ID of the mechanical bike.
     *
    ...
    /**
     * Gets the location of the mechanical bike.
     *
    ...
    /**
     * Sets the location of the mechanical bike.
     *
    ...
    /**
     * Gets the docking station where the mechanical bike is located.
     *
    ...
    /**
     * Sets the docking station where the mechanical bike is located.
     *
